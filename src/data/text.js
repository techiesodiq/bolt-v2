export const home = {
  hero: {
    title: "Transform your Business operations with the best Fiber Solution",
    description:
      "We are at the forefront of the telecommunications industry, providing high-quality fiber optic solutions to homes and businesses across the country.",
    button: "Contact Us",
    image: require("../asset/van.png"),
  },
  count: {
    title: "Number of Splices Completed:",
    count: 316171,
  },
  service: {
    ...
    bgImage: require("../asset/WhatsApp Image 2023-07-06 at 09.29.06.jpg"),
    solutions: [
      {
    ...
    options: [
      {
        ...
        description:
          "We are viewed as a leader in the telecommunication industry and we take every opportunity to enhance our safety and training programs, and ultimately, our safety performance.We are working with industry to pave the road to “ZERO”.",
      },
      {
